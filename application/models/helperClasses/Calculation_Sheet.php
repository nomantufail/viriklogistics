...
class Calculation_Sheet {
    ...
    public function set_data($obj)
    {
        ...
        $shortage_details = $this->shortage_details($obj->shortage_quantity, $obj->shortage_rate, $obj->price_unit);
    ...
    public function shortage_details($qty , $rate, $price_unit)
    {
        ...
        $shortage_details = array(
            'qty' => $qty,
            'price_unit' => ($rate == 0)?$price_unit:$rate,
        );
