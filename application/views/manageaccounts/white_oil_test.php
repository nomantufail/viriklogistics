...
<tr>
    ...
    <th><div><input id="" type="checkbox" name="column[]" value="product_quantity" style="" checked></div></th>
    ...
    <th><div><input id="" type="checkbox" name="column[]" value="stn" style="" checked></div></th>
    <th><div><input id="" type="checkbox" name="column[]" value="company" style="" checked></div> </th>
    <th><div><input id="" type="checkbox" name="column[]" value="company_freight_unit" style="" checked></div> </th>
    <th><div><input id="" type="checkbox" name="column[]" value="total_freight_for_company" style="" checked></div> </th>
    ...
    <th><div><input id="" type="checkbox" name="column[]" value="contractor_freight" style="" checked></div></th>
    <th><div><input id="" type="checkbox" name="column[]" value="contractor_freight_without_shortage_amount" style="" checked></div></th>
    ...
    <th><div><input id="" type="checkbox" name="column[]" value="customer_freight_unit" style="" checked></div> </th>
    <th><div><input id="" type="checkbox" name="column[]" value="total_freight_for_customer" style="" checked></div> </th>
    <th><div><input id="" type="checkbox" name="column[]" value="customer_net_freight" style="" checked></div></th>
    <th><div><input id="" type="checkbox" name="column[]" value="customer_freight_without_shortage" style="" checked></div></th>
    <th><div><input id="" type="checkbox" name="column[]" value="contractor_service_charges" style="" ></div></th>
...
<?php $parent_count = 0; ?>
    ...
    <tr>
        ...
        td(rupee_format(round($detail->total_freight_cmp, 3)));
        td($detail->wht." %: ".round($detail->wht_amount, 3));
        td($detail->company_commission." %: ".round($detail->company_commission_amount, 3));
        ...
        td($detail->contractor_commission." %: ".round($detail->contractor_commission_amount, 3));
        td($detail->customer);
        td(round($detail->freight_unit_cst, 3));
        td(round($detail->total_freight_cst, 3));
        td(round($detail->customer_freight_amount, 3));
        td(round($detail->customer_freight_without_shortage, 3));
        td(round($detail->service_charges, 3));
        td($detail->billed);
        ?>
    </tr>
