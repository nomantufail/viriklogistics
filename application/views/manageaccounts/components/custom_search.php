...
<div id="advance_options">
        ...
        <div class="col-md-6">
            ...
            <select name="contractor[]" multiple class="contractors_select">
                ...
                <?php foreach($contractors as $contractor): ?>
                    <?php
                    $selected = ($selected_contractor == $contractor->id)?'selected':'';
                    ?>
    ...
    <fieldset>
        ...
        <div class="col-md-6">
            <label class="lable">From:</label> <input style="width: 100%;" type="date" placeholder="" value="<?php if(isset($_GET['from'])){echo $_GET['from'];} ?>" name="billed_from">
        </div>
        <div class="col-md-6">
            <label class="lable">To:</label>  <input type="date" placeholder="" value="<?php if(isset($_GET['to'])){echo $_GET['to'];} ?>" name="billed_to">
        </div>
        <div class="col-md-6">
